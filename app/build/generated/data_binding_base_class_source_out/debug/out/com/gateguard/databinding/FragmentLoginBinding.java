...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  private FragmentLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull ProgressBar progressBar, @NonNull TextInputLayout tilLoginEmail,
      @NonNull TextInputLayout tilLoginPassword, @NonNull TextView tvAppTitle,
      @NonNull TextView tvForgotPassword, @NonNull TextView tvGoToRegister,
      @NonNull TextView tvLoginSubtitle) {
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLoginBinding((ConstraintLayout) rootView, btnLogin, etLoginEmail,
          etLoginPassword, progressBar, tilLoginEmail, tilLoginPassword, tvAppTitle,
          tvForgotPassword, tvGoToRegister, tvLoginSubtitle);
    }
