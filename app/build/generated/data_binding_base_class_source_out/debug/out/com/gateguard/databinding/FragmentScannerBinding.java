...
public final class FragmentScannerBinding implements ViewBinding {
  ...
  private FragmentScannerBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnClose,
      @NonNull View scanOverlay, @NonNull TextView tvInstruction, @NonNull PreviewView viewFinder) {
  ...
  public static FragmentScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentScannerBinding((ConstraintLayout) rootView, btnClose, scanOverlay,
          tvInstruction, viewFinder);
    }
